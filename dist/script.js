...
var changeModalState = function changeModalState(state) {
  ...
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_1__["default"])('#height'); // передаем событие, елемент, и название знач prop для state|
  ...
  ;
  bindActionToElems('click', windowForm, 'prop');
